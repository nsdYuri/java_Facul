...
public class Funcionario {
		...
		//Função que aumenta o salario em 2%
		public void aumentarSalario() {
			salario *= 1.02;
			//aumentarSalario(2);
		}
		
		//Aumentar o salario de acordo com a porcentagem (10%, 20%...)
		public void aumentarSalario(double porcentagem) {
			salario *= porcentagem / 100 + 1;
		}
		
		//Aumentar o salario de acordo com o nivel: Junior(2000), Pleno(5000), Senior(8000)
